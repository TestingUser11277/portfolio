      ...
      <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          <div>
            ...
            >
              Hey there! I&apos;m <span className="text-primary">Anil</span>{" "}
              ✨
            </motion.h1>
            <motion.div
              initial={{ opacity: 0 }}
          ...
          >
            ...
            exploring new tech or playing chess!
          </motion.p>
            ...
            >
              ...
              <div className="p-4 font-mono text-sm md:text-base overflow-hidden h-[calc(100%-2.5rem)]">
                <div className="flex">
                  ...
                  <span className="text-foreground mx-2">anil</span>
